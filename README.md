...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/captcha-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12945&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/captcha-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `captcha` can be installed with:

```
conda install captcha
```

It is possible to list all of the versions of `captcha` available on your platform with:
